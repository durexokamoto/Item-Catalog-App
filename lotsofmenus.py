...
catagory2 = Catagory(user_id=1, name="Basketball")
...
catagory1 = Catagory(user_id=1, name="Baseball")
...
# Catalog for Frisbee
catagory1 = Catagory(user_id=1, name="Frisbee")
...
catagory1 = Catagory(user_id=1, name="Snowboarding")
...
catagory1 = Catagory(user_id=1, name="Rock Climbing")
...
# Catalog for Hockey
catagory1 = Catagory(user_id=1, name="Hockey")
...
# Catalog for Skating
catagory1 = Catagory(user_id=1, name="Skating")
